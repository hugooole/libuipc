// Bazel entry point for hello_affine_body.
// Mirrors main.cpp but resolves the backend module dir via runfiles and calls
// uipc::init(), instead of the CMake app/AssetDir compile-time paths.
...
int main(int argc, char** argv)
{
    ...
    auto output_path = env.output_dir("hello_affine_body_output");
    ...
    for(int i = 1; i < 50; i++)
    {
        ...
        world.sync();
        world.retrieve();
        sio.write_surface(fmt::format("{}scene_surface{}.obj", output_path, i));
    }
